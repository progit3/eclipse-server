...
## Медиа
<!-- Прикрепите медиафайлы, если PR вносит изменения в игру (одежда, предметы, механики и т.д.). Является необязательным для простых изменений. -->
...
- [ ] Я протестировал(а) свой код на наличие багов и подтверждаю что баги или ошибки отсутствуют в коде
