...
nukeops-welcome =
    You are a nuclear operative. Your goal is to blow up {$station}, and ensure that it is nothing but a pile of rubble. Your bosses, the Legion, have provided you with the tools you'll need for the task.
...
nukeops-opsmajor = [color=crimson]Legion major victory![/color]
nukeops-opsminor = [color=crimson]Legion minor victory![/color]
...
nukeops-cond-nukeactiveatcentcom = The nuclear bomb was armed and delivered to the Eidos Empire!
