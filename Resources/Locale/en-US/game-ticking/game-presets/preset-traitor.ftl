...
objective-issuer-legion = [color=crimson]The Legion[/color]
...
traitor-role-greeting =
    You are an agent sent by [color = darkred]The Legion[/color] on behalf of {$corporation}.
...
traitor-role-codewords =
    ...
    {$codewords}.[/color]
    Codewords can be used in regular conversation to identify yourself discreetly to other legion agents.
