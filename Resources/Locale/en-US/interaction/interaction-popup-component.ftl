...
petting-success-legion-cyborg = You pet {THE($target)} on {POSS-ADJ($target)} menacing metal head.
...
petting-failure-legion-cyborg = You reach out to pet {THE($target)}, but {POSS-ADJ($target)} treacherous affiliation makes you reconsider.
