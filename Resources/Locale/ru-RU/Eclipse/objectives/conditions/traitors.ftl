objective-condition-humiliate-person-title = Публично опозорьте { $targetName }, { CAPITALIZE($job) }.
...
objective-condition-recruiting-person-title = Завербуйте { $targetName }, { CAPITALIZE($job) } в Легион.
