...
blob-target-already-connected = К узлу уже присоеденён данный тип тайла
...
ghost-role-information-blob-description = Ядро блоба
...
blob-carrier-role-greeting = Вы антагонист. У вас есть 4 минуты перед тем как вы превратитесь в блоба.
role-subtype-blob = Сущность зараженная "блобом"
...
objective-condition-success = Захватить станцию: [color=Green] Блоб поглатил станцию [/color] 
