...
guidebook-SOP-codes-red-terms =
    ...
    Примеры:
    - В случае запроса у Эйдосской империи установки [color=gold]гамма кода[/color].
    ...
    - Убийство или пропажа капитана, магистрата, представителей ЭИ/ДСО.
...
guidebook-SOP-codes-gamma =
    ...
    {"[bold]Устанавливается:[/bold] Эйдосской империей по запросу командования станции или по собственной инициативе."}
...
guidebook-SOP-codes-delta =
    ...
    {"[bold]Устанавливается:[/bold] Эйдосской империей по запросу командования или запуском механизма самоуничтожения станции."}

guidebook-SOP-codes-delta-terms =
    - Механизм самоуничтожения станции был запущен.
    - Эйдосская империя подтвердила неминуемое уничтожение станции.

guidebook-SOP-codes-delta-norms =
    - Распоряжения, полученные от Эйдосской империи или департамента специальных операций должны быть исполнены в полном объеме.
      - В случае отсутствия распоряжений от Эйдосской империи или департамента специальных операций необходимо организовать незамедлительную эвакуацию.
    - Все нормы экипажа и распоряжения утрачивают силу, кроме:
      - распоряжения Эйдосской империи или департамента специальных операций;
      - приказы капитана;
...
guidebook-SOP-codes-octarine =
    ...
    {"[bold]Устанавливается:[/bold] Эйдосской империей."}

guidebook-SOP-codes-octarine-terms =
    - Эйдосская империя зафиксировала угрозу, серьёзно искажающую реальность.
