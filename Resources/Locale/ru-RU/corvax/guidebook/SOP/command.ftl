...
guidebook-SOP-command-general-must =
    1. Обеспечить продуктивность при выполнении отделом должностных обязанностей и указаний Эйдосской империи, при необходимости выполнять работу самому.
    ...
    1. Предоставлять информацию о деятельности отдела по запросу капитана, АВД, магистрата, сотрудников СБ, представителей ЭИ и ДСО.
    ...
    1. При получении от агента внутренних дел жалобы или отчёта о внутреннем расследовании, в течение 10 минут подготовить письменный отчёт об устранении нарушений и предоставить его копии агенту внутренних дел и капитану.
      - Если жалоба или отчёт о расследовании составлены в отношении капитана, то капитан обязан предоставить копию отчёта об устранении нарушений не только АВД, но и Эйдосской империи.
...
guidebook-SOP-command-general-right =
    ...
    1. Написать запрос на вызов членов Эйдосской империи.
    1. Изменять заработную плату подчинённых сотрудников, но не более, чем на 20% от стандартного оклада.
      ...
      - Все документы, касающиеся изменения заработной платы, должны быть переданы Эйдосской империи после или во время смены.
...
guidebook-SOP-Captain-must =
    ...
    1. Докладывать Эйдосской империи об угрозах и проблемах, значительно влияющих на работоспособность станции.
...
guidebook-SOP-Captain-right =
    1. [bold]Вето.[/bold] Капитан может отменить приказ или решение любого сотрудника станции.
      ...
      - Данный пункт не действует в отношении [tooltip="guidebook-SOP-command-tooltip-corporate-agents" text="корпоративных агентов"].
    1. Выдать и подписать любой дозволяющий документ.
    1. Принимать решение об эвакуации после консультации с Эйдосской империей или самостоятельно в случае ЧС.
    ...
    1. Покидать станцию при эвакуации, посещении пристыкованного шаттла с разрешения владельца или при получении письменного разрешения Эйдосской империи.
    1. Выходить в космическое пространство при проверке цели, необходимости попасть в изолированный отсек, прямой угрозе жизни капитана или получении письменного разрешения Эйдосской империи.
...
guidebook-SOP-command-procedure-appoint-acting-captain =
    ...
    1. Эйдосская империя должна быть уведомлена о назначении ВрИО капитана.
...
guidebook-SOP-command-procedure-remove-captain =
    1. Капитан может быть уволен по собственному желанию, по приказу Эйдосской империи или при решении не анонимного голосования глав в соответствии с причинами отстранения от должности.
      - ВрИО капитан обязан вернуться на свою изначальную должность после прибытия нового капитана из Эйдосской империи.
...
guidebook-SOP-command-procedure-remove-acting-head =
    1. ВрИО глава отдела обязан вернуться на свою изначальную должность, сдать выданное снаряжение и доступы после прибытия нового главы из Эйдосской империи.
...
guidebook-SOP-command-procedure-accesses =
    ...
    1. Должности Эйдосской империи/ДСО могут быть назначены только Эйдосской империей/ДСО.
...
guidebook-SOP-command-procedure-promotion-transfer =
    ...
    1. Пакет документов направляется в Эйдосскую империю; при отсутствии отказа в течение 5 минут процедура считается успешной.
    1. Нельзя повысить до смотрителя, главы отдела или капитана без согласия ЭИ (cтановление ВрИО не является повышением).
...
guidebook-SOP-command-procedure-removal-from-post =
    ...
    1. Агент внутренних дел может быть уволен только по решению магистрата; отстранить его могут представители ЭИ/ДСО.
    1. Должности Эйдосской империи/ДСО могут быть уволены только Эйдосской империей/ДСО.
    ...
    1. Глава отдела или капитан, высланный с ЭИ вследствие бюрократической ошибки, обязан сдать свои полномочия, если действующий глава отдела или капитан не являются ВрИО.
...
guidebook-SOP-command-protocol-evacuation =
    ...
    1. Запрос оформляется письменно, после получения ЭИ отчёта о ситуации.
      - В случае ЧС допускается устный отчёт и запрос с использованием красного телефона.
    1. Эвакуационный шаттл вызывается ЭИ, в случае отсутствия ответа от ЭИ в течение 5 минут или при ЧС капитаном или другим главой.
