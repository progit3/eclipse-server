...
guidebook-SOP-ChiefMedicalOfficer-right =
    ...
    1. Издавать приказ о принудительном психиатрическом лечении члена экипажа.
      ...
      - Если документ касается лиц с юридической неприкосновенностью, он должен быть заверен печатью Эйдосской империи.
...
guidebook-SOP-medical-procedure-bodies =
    ...
    1. Тела неклонированных членов экипажа должны быть транспортированы на станцию Эйдосской империи в мешках для трупов.
...
guidebook-SOP-medical-procedure-psychiatric =
    ...
    1. Если пациент представляет угрозу для окружающих, главный врач должен в кратчайшие сроки организовать его принудительное лечение, издав соответствующий приказ и организовав размещение в изоляции от общества.
      ...
      - В случае отсутствия положительной динамики во время лечения, пациент должен быть закован и доставлен на станцию Эйдосской империи по завершению смены;
...
guidebook-SOP-medical-confidentiality =
    ...
    - Прямого запроса капитана или Эйдосской империи.
...
guidebook-SOP-medical-tooltip-sensitive-positions = Капитан; Главы отделов; Сотрудники СБ; Сотрудники юридического департамента; Члены ЭИ и ДСО.
