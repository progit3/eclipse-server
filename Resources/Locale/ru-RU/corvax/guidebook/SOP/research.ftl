...
guidebook-SOP-ResearchDirector-must =
    ...
    1. Обеспечивать сохранность и стабильную работу генератора аномалий. В случае потери генератора аномалий ввиду непредсказуемых обстоятельств — срочно сообщить об утере всем главам и написать отчёт ЭИ с подробным описанием обстоятельств.
