...
guidebook-SOP-security-general-must =
    ...
    1. Соблюдать субординацию и использовать [tooltip="guidebook-SOP-security-tooltip-regulation-speech" text="уставную речь"] при общении с сотрудниками СБ, членами командования, сотрудниками юридического департамента, представителями Эйдосской империи и ДСО.
    ...
    1. В полной мере сотрудничать с членами Эйдосской империи и ДСО, прибывшими на станцию.
    1. Исполнять законные требования представителей юридического департамента и Эйдосской империи, а также требования вышестоящих по иерархии лиц.
...
guidebook-SOP-SecurityPilot-prohibited =
    ...
    1. Покидать пределы космического пространства станции без прямого разрешения Эйдосской империи.
...
guidebook-SOP-security-procedure-investigation-rozysk =
    ...
    1. Достаточно показаний одного свидетеля, если он является членом командования, сотрудником службы безопасности, сотрудником юридического департамента, Эйдосской империи или департамента специальных операций.
...
guidebook-SOP-security-procedure-investigation-analysis =
    ...
    1. Прямыми доказательствами являются:
      ...
      - Личное свидетельство правонарушения сотрудниками СБ и уполномоченными должностными лицами: капитаном станции, представителями ЭИ, членами ИКР или РХБЗЗ.
...
guidebook-SOP-security-procedure-investigation-verdict =
    ...
    1. магистрат;
    1. сотрудники Эйдосской империи и департамента специальных операций;
    1. капитан;
    ...
    1. После оглашения вердикта приговор вступает в силу и осуждённого подвергают вынесенному наказанию.
...
guidebook-SOP-security-procedure-investigation-implementation =
    ...
    1. После окончания срока заключения осуждённый должен быть освобожден, законное имущество должно быть возвращено, а статус в консоли криминальных записей должен быть изменён на «Освобождён».
      - Если срок заключения не завершился к моменту прибытия эвакуационного шаттла, то заключенный должен быть конвоирован на шаттл и доставлен на станцию Эйдосской империи.
    ...
    1. При завершении смены заключенный должен быть конвоирован на эвакуационный шаттл и доставлен на станцию Эйдосской империи.
    ...
    1. После исполнения приговора осуждённому в консоли криминальных записей требуется добавить запись «Приговор исполнен».
      - Если приговор не был исполнен до момента прибытия эвакционного шаттла, то заключенный должен быть конвоирован на шаттл и доставлен на станцию Эйдосской империи.
...
guidebook-SOP-security-procedure-parole-general =
    1. Оформить УДО уполномочены помощник смотрителя, смотритель, ГСБ, капитан, магистрат. Также оформление УДО возможно по указу Эйдосской империи.
...
guidebook-SOP-security-procedure-parole-obtaining =
    ...
    1. В зависимости от типа наказания, оформить УДО уполномочены:
      ...
      - При оформлении УДО на особых условиях — ЭИ или магистрат.
    ...
    1. В отношении заключенного должен быть издан специальный приказ:
      ...
      - Приказ на УДО на особых условиях должен быть заверен печатью ЭИ или магистрата.
    ...
    1. Предоставление УДО на особых условиях:
      - Если заключенный не соответствует стандартным критериям для получения УДО, то данная процедура может быть исполнена лишь по письменному приказу ЭИ или магистрата.
...
guidebook-SOP-security-procedure-unregistered-protocol =
    ...
    1. В зависимости от результатов расследования капитан станции может принять следующие меры в отношении задержанного лица:
      ...
      - В случае, если мотивы задержанного установить не удалось либо задержанный не заслуживает доверия, он должен содержаться в пермабриге для дальнейшей доставки на станцию Эйдосской империи. В отношении данного лица действуют правила содержания для заключенных пермабрига.
...
guidebook-SOP-security-tooltip-officials = Капитан; Главы отделов; Сотрудники СБ; Сотрудники юридического департамента; Представители Эйдосской империи; ДСО.
...
guidebook-SOP-security-tooltip-legal-immunity = Неприкосновенностью обладают капитан, все сотрудники юридического департамента, Эйдосская империя и ДСО.
