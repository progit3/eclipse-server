...
guidebook-SOP-HeadOfPersonnel-must =
    ...
    1. Хранить и доставить в Эйдосскую империю все документы, касающиеся изменений уровней доступов сотрудников.
...
guidebook-SOP-service-tooltip-Bartender-officials = К должностным лицам относятся сотрудники СБ, сотрудники юридического департамента, главы отделов, капитан, члены ЭИ и прочие сотрудники НТ, не относящиеся к персоналу станции.
