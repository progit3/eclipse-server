...
book-zp-contents =
    ...
    Награждение медалью добавляет 50% к итоговой заработной плате. Быстрое окончание смены добавляет 50% к заработной плате руководителей отделов. Эйдосская империя может по своему усмотрению назначить дополнительную премию по итогам смены.
book-ussp-contents =
    Первые среди равных
