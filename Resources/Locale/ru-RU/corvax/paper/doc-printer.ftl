doc-text-printer-report-station =
    ...
    ⠀[color=#1b487e]░░░░██░░██░██░██░[/color] [bold]:СТАНЦИЯ: КОМ-ЭИ[/bold]
    ⠀[color=#1b487e]░░░░██░░░████░███[/color]
     =============================================
                                 ОТЧЁТ О СИТУАЦИИ
     =============================================
...
doc-text-printer-application-appointment-interim =
    ...
    При вступлении в должность обязуюсь следовать Стандартным Рабочим Процедурам и до появления Главы (полное наименование отдела)/Капитана из Эйдосской империи обеспечивать порядок и управление отделом, обеспечивать сохранность вверяемых мне особо ценных предметов и снаряжения.
    
    По прибытии Главы отдела/Капитана из Эйдосской империи обязуюсь сдать повышенный доступ, особо ценные предметы и снаряжение.
    =============================================
                                ⠀[italic]Место для печатей[/italic]
...
doc-text-printer-letter-resignation =
    ...
    Обязуюсь заплатить штраф, установленный условиями расторжения срочного/бессрочного контракта, на объекта Эйдосской империи.
    =============================================
                                ⠀[italic]Место для печатей[/italic]
...
doc-text-printer-evacuation-shuttle-request =
    ...
    Уважаемая Эйдосская империя! Я, :ФИО:, в должности :ДОЛЖНОСТЬ:, прошу запустить протоколы эвакуации и прислать эвакуационный шаттл, приняв решение об окончании смены.
...
doc-text-printer-ordering-special-equipment =
    ...
    Я, :ФИО:, в должности :ДОЛЖНОСТЬ:, прошу предоставить специальное снаряжение станции от Эйдосской империи.
...
doc-text-printer-error-loading-form-header =
    ...
    ⠀[color=#B50F1D] █░░░░████░░░░█[/color]             [head=3]Legion[/head]
...
doc-text-printer-notice-of-liquidation =
    ...
    Уважаемый (ФИО), в должности (полное наименование должности)! Руководством Легиона принято решение о вашей немедленной ликвидации в ходе данной смены. Просим заранее подготовить завещание и направить его Медицинскому отделу станции. Уничтожение вашего тела будет произведено силами Легиона.
    Причина ликвидации:
...
doc-text-printer-business-deal =
    ...
    Легион любезно предлагает заключить сделку между станцией и агентом (позывной агента). Со стороны станции необходимо:
...
doc-text-printer-note-beginning-military-actions =
    ...
    Неуважаемые корпоративные крысы NanoTrasen! Легион официально объявляет о начале военных действий с вами, а также о начале операции по вашему истреблению.
...
doc-text-printer-report-accomplishment-goals =
    ...
    Я, (позывной агента), успешно выполнил поставленные передо мной руководством Легиона цели. Прошу принять отчёт о выполнении.
    Отчёт:
