...
station-goal-news-author = Эйдосская империя
...
station-goal-artifacts =
    ...
    Каждый документ должен быть подтверждён печатью научного руководителя или капитана. Артефакты с документацией должны быть доставлены на станцию Эйдосской империи.
...
station-goal-theatre =
    ...
    В случае проведения тестового представления сервисный отдел станции будет вознагражден по прибытию на Станцию ЭИ.
    По окончании работ ЭИ может прислать представителя для проведения тестового представления.
...
station-goal-frame-repair =
    ...
    Для помощи в выполнении цели Эйдосская империя будет каждые пять минут высылать припасы на специальной посадочной площадке в центре станции.
