...
delivery-spam-2 =   Причины выбрать Nanotrasen!
    ...
    .content =      { -delivery-header-nanotrasen }
                    ...
                    { "[head=2]ТОП ТРИ ПРИЧИНЫ НЕКОМПЕТЕНТНОСТИ ЛЕГИОНА[/head]" }
                    ...
                    ИХ МИРНЫЕ СОТРУДНИКИ УЯЗВИМЫ К ПУЛЯМ! ПОВЕРЬТЕ, МЫ ПРОВЕРЯЛИ! В ОТЛИЧИЕ ОТ СОТРУДНИКОВ NANOTRASEN, МИРНЫЕ СОТРУДНИКИ ЛЕГИОНА ДОХНУТ ОТ ОДНОЙ ПУЛИ В ЛОБ! А ПУЛИ У НАС ЕСТЬ!
...
delivery-spam-3 =   Причины выбрать Легион!
    .desc =         Реклама Легиона.
