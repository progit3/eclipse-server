...
ent-ActionOpenUplinkImplantAshLegion = Открыть терминал снабжения
    .desc = Открывает терминал снабжения Легиона пепла, скрытый под вашей кожей.
ent-ActionOpenUplinkImplant = Открыть терминал снабжения
    .desc = Открывает терминал снабжения Синдиката, скрытый под вашей кожей.
