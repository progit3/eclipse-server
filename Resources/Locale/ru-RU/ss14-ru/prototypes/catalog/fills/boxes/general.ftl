...
ent-BoxEncryptionKeyService = коробка ключей шифрования сервисного отдела
    .desc = { ent-BoxEncryptionKeyPassenger.desc }
ent-BoxEncryptionKeyAshLegion = коробка ключей шифрования Легиона Пепла
    .desc = Два ключа шифрования легиона по цене одного. Для простоты использования уменьшена.
