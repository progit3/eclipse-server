...
ent-ThrowingKnivesKit = набор метательных ножей
    .desc = Набор из 4 фирменных метательных ножей Легиона, идеально подходящих для вонзания в тело жертвы.
...
ent-LegionmovCircuitKit = набор Легионмов
    .desc = Комплект, содержащий электронную плату с набором законов Легион и ID карту Легиона
