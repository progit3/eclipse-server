...
ent-BriefcaseLegionSniperBundleFilled = { ent-BriefcaseBrown }
    .desc = { ent-BriefcaseBrown.desc }
    .suffix = Заполненный, Христов
ent-BriefcaseLegionLobbyingBundleFilled = { ent-BriefcaseLegion }
    .desc = { ent-BriefcaseLegion.desc }
    .suffix = Легион, Кредиты
ent-BriefcaseThiefBribingBundleFilled = { ent-BriefcaseLegion }
    .desc = { ent-BriefcaseLegion.desc }
    .suffix = Вор, Кредиты
