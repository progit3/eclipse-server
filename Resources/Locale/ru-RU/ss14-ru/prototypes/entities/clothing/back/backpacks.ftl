...
ent-ClothingBackpackDeathSquad = рюкзак эскадрона смерти
    .desc = Вмещает снаряжение самых устрашающих агентов Эйдосской империи.
ent-ClothingBackpackLegion = рюкзак Легиона
