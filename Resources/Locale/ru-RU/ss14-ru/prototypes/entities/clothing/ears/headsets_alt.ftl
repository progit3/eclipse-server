...
ent-ClothingHeadsetAltCentCom = полноразмерная гарнитура Эйдосской империи
    .desc = { ent-ClothingHeadsetAlt.desc }
...
ent-ClothingHeadsetAltScience = полноразмерная гарнитура НР
    .desc = { ent-ClothingHeadsetAlt.desc }
ent-ClothingHeadsetAltLegion = полноразмерная кроваво-красная гарнитура
    .desc = Модифицированный модульный интерком Легиона, надеваемый на голову, и содержащий ключ шифрования. Имеет 5 ячеек для ключей шифрования.
