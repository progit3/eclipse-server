ent-ClothingNeckCloakCentcom = плащ представителя Эйдосской империи
    .desc = Помпезный и элитнейший зелёный плащ с изящной золотой отделкой, сшитый специально для представителя Эйдосской империи. Он такой тяжёлый, что золотая отделка вполне может быть настоящей.
