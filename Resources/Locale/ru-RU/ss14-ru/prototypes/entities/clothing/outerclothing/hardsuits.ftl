...
ent-ClothingOuterHardsuitLegionCommander = скафандр командира Легиона
    .desc = Усиленная версия кроваво-красного скафандра, предназначенная для командиров оперативных отрядов Легиона. Броня значительно усилена для ведения смертоносных боёв на передовой.
