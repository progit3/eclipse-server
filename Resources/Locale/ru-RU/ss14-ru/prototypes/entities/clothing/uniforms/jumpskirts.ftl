...
ent-ClothingUniformJumpskirtCentcomFormalDress = торжественное платье Эйдосской империи
    .desc = Платье для особых случаев.
...
ent-ClothingUniformJumpskirtLegionFormalDress = торжественное платье Легиона
