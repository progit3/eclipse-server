...
ent-BorgChassisService = киборг-официант
    .desc = { ent-BorgChassisSelectable.desc }
ent-BorgChassisLegionAssault = штурмовой киборг Легиона
    .desc = Машина для убийств с доступом к различным смертоносным модулям.
ent-BorgChassisLegionMedical = медицинский киборг Легиона
...
ent-BorgChassisLegionSaboteur = саботажный киборг Легиона
...
ent-LegionAssaultBorgChassisDerelict = брошенный штурмовой киборг Легиона
