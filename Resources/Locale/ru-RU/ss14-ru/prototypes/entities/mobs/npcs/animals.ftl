...
ent-MobBaseLegionMonkey = обезьяна
    .desc = Новая церковь неодарвинистов действительно верит, что КАЖДОЕ животное произошло от обезьяны. На вкус они как свинина, а убивать их весело и приятно.
    .suffix = Легион, Базовый
ent-MobMonkeyLegionAgent = { ent-MobBaseLegionMonkey }
    .desc = { ent-MobBaseLegionMonkey.desc }
    .suffix = Легион
ent-MobMonkeyLegionAgentNukeops = { ent-MobBaseLegionMonkey } (Не использовать)
    .desc = { ent-MobBaseLegionMonkey.desc }
...
ent-MobBaseLegionKobold = { ent-MobBaseKobold }
    .desc = { ent-MobBaseKobold.desc }
    .suffix = Легион, Базовый
ent-MobKoboldLegionAgent = { ent-MobBaseLegionKobold }
    .desc = { ent-MobBaseLegionKobold.desc }
    .suffix = Агент Легиона
ent-MobKoboldLegionAgentNukeops = { ent-MobBaseLegionKobold } (Не использовать)
    .desc = { ent-MobBaseLegionKobold.desc }
    .suffix = Легион пепла (Не использовать)
...
ent-MobGrenadePenguin = пингвин гренадёр
    .desc = Маленький пингвин с гранатой на шее. Заготавливается Легионом на неблагоприятных ледяных планетах.
