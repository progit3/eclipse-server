...
ent-RandomHumanoidChallengeCargoTechnician = жертва катастрофы грузчик роль призрака
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
    .suffix = ЧЕЛЛЕНДЖ
ent-RandomHumanoidLegionSoldierTeamLeader = Легион руководитель роль призрака
    .desc = { "" }
ent-RandomHumanoidLegionSoldier = Легион солдат роль призрака
    .desc = { "" }
ent-RandomHumanoidLegionVisitor = Легион жертва катастрофы роль призрака
    .desc = { "" }
