...
ent-CigPackLegion = пачка трав Интердайн
    .desc = Элитные сигареты для элитных агентов Легиона. Насыщенные лекарствами, когда вам нужно больше, чем просто успокоить нервы.
