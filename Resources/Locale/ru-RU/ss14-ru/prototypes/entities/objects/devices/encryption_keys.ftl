...
ent-EncryptionKeyCentCom = ключ шифрования Эйдосской империи
...
ent-EncryptionKeyLegion = Подозрительный тёмно-оранжевый ключ шифрования
...
ent-EncryptionKeyBinaryLegion = ключ двоичного перевода
    .desc = Ключ шифрования Легиона, используемый для преобразования двоичного кода, используемого синтетиками.
