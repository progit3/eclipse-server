...
ent-CentcomPDA = КПК Эйдосской империи
...
ent-LegionPDA = КПК Легиона
    .desc = Окей, пора стать продуктивным членом... о, круто, я плохой парень, пора убивать людей!
ent-LegionOperativePDA = КПК оперативника Легиона (Не использовать)
    .desc = Смерть НТ!
ent-LegionCorpsmanPDA = КПК медика Легиона (Не использовать)
    .desc = Командир... Мне надо варить!
ent-LegionCommanderPDA = КПК командира Легиона (Не использовать)
    .desc = Так мы что, какой-то отряд нюкеров?
ent-ERTLeaderPDA = КПК ИКР
    .desc = Красный значит мощный.
    .suffix = Лидер
ent-ERTChaplainPDA = КПК священника ИКР
    .desc = Красный значит мощный. Он благословен.
    .suffix = Священник
ent-ERTEngineerPDA = КПК инженера ИКР
    .desc = Красный значит мощный. Он изрядно потрёпан.
    .suffix = Инженер
ent-ERTJanitorPDA = КПК уборщика ИКР
    .desc = Красный значит мощный. Чистый аж поскрипывает.
    .suffix = Уборщик
ent-ERTMedicPDA = КПК врача ИКР
    .desc = Красный значит мощный. Он блестит и стерилен.
    .suffix = Врач
ent-ERTSecurityPDA = КПК офицера безопасности ИКР
