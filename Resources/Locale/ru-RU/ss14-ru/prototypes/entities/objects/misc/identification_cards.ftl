...
ent-NukieAgentIDCard = { ent-AgentIDCard }
    ...
    .suffix = Оперативники
ent-LegionIDCard = ID-карта Легиона
    .desc = { ent-IDCardStandard.desc }
ent-LegionOperativeIDCard = ID-карта оперативника Легиона (Не использовать)
    .desc = { ent-LegionIDCard.desc }
ent-LegionCorpsmanIDCard = ID-карта медика Легиона (Не использовать)
    .desc = { ent-LegionOperativeIDCard.desc }
ent-LegionCommanderIDCard = ID-карта командира Легиона (Не использовать)
    .desc = { ent-LegionOperativeIDCard.desc }
...
ent-CentcomIDCard = ID-карта старшего офицера
    .desc = { ent-IDCardStandard.desc }
ent-ERTLeaderIDCard = ID-карта лидера ИКР
    .desc = { ent-IDCardStandard.desc }
ent-ERTChaplainIDCard = ID-карта священника ИКР
    .desc = { ent-IDCardStandard.desc }
ent-ERTEngineerIDCard = ID-карта инженера ИКР
    .desc = { ent-IDCardStandard.desc }
ent-ERTJanitorIDCard = ID-карта уборщика ИКР
    .desc = { ent-IDCardStandard.desc }
ent-ERTMedicIDCard = ID-карта врача ИКР
    .desc = { ent-IDCardStandard.desc }
ent-ERTSecurityIDCard = ID-карта офицера ИКР
    .desc = { ent-IDCardStandard.desc }
