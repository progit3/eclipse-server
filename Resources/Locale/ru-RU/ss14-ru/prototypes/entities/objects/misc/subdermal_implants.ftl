...
ent-RadioImplant = имплант "радио"
    .desc = Этот имплант даёт доступ к радиочастоте Легиона без гарнитуры.
ent-UplinkImplant = имплант "терминал снабжения"
    .desc = Этот имплант позволяет пользователю получить доступ к скрытому терминалу снабжения Легиона по желанию.
...
ent-VoiceMaskImplant = имплант "голосовая маска"
...
ent-DeathRattleImplant = имплант "предсмертный хрип"
    .desc = Этот имплант сообщит по радиоканалу Легиона, если пользователь окажется в критическом состоянии или умрёт.
...
ent-RadioImplantCentcomm = имплант "радио"
    .desc = Этот имплант даёт доступ к радиочастоте Эйдосской империи без гарнитуры. Разрешено только сотрудникам Эйдосской империи.
ent-DeathRattleImplantCentcomm = имплант "предсмертный хрип" Эйдосской империи
    .desc = Этот имплант сообщит по радиоканалу Эйдосской империи, если пользователь окажется в критическом состоянии или умрёт.
