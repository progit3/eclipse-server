...
ent-BaseBorgModuleService = { ent-BaseBorgModule }
    .desc = { ent-BaseBorgModule.desc }
ent-BaseBorgModuleLegion = { ent-BaseBorgModule }
    .desc = { ent-BaseBorgModule.desc }
ent-BaseBorgModuleLegionAssault = { ent-BaseBorgModule }
    .desc = { ent-BaseBorgModule.desc }
...
ent-BorgModuleLegionWeapon = оружейный модуль киборга
    .desc = { ent-BaseBorgModule.desc }
ent-BorgModuleOperative = оперативный модуль киборга
    .desc = Модуль, в который входят монтировка,"Емаг", взломщик доступа и пинпоинтер Легиона.
ent-BorgModulePlasmaSwordAlt = модуль киборга c плазменным мечом
