...
ent-LegionFlippo = кроваво-красная флиппо
...
ent-CentCommFlippo = позолоченная флиппо Эйдосской империи
    .desc = Изысканная флиппо, с рельефным, нефритовым с позолотой корпусом, турбо-пламя которой создаётся блюспейсом. Кнопка защищена миниатюрным считывателем доступов, который реагирует только на сотрудников Эйдосскую империю. Самая красивая зажигалка, известная человечеству.
    .suffix = НЕ МАППИТЬ
