...
ent-CyborgPlasmaScythe = { ent-EnergySwordDouble }
    .desc = Стажеры из командования Легиона Пепла решили, что меч как-то не солидно, поэтому прикрепили плазменную косу.
