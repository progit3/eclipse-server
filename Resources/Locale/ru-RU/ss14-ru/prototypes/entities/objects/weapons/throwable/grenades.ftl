...
ent-GrenadeFlashEffect = { "" }
    .desc = { "" }
ent-LegionMiniBomb = минибомба Легиона
    .desc = Взрывное устройство, изготовленное Легионом, предназначенное сеять хаос и разрушение.
...
ent-LegionTrickyBomb = хитробомба Легиона
    .desc = Взрывчатка, изготовленная легионом, служит отличным отвлекающим манёвром.
