...
ent-AirlockExternalLegionLocked = { ent-AirlockExternal }
    .desc = { ent-AirlockExternal.desc }
    .suffix = Внешний, Легион, Закрыт
ent-AirlockExternalNukeopLocked = { ent-AirlockExternal } (Не использовать)
    .desc = { ent-AirlockExternal.desc }
    .suffix = Внешний, Легион пепла, Закрыт (Не использовать)
...
ent-AirlockCentralCommandLocked = { ent-AirlockCentralCommand }
    ...
    .suffix = Эйдосская империя, Закрыт
...
ent-AirlockExternalGlassLegionLocked = { ent-AirlockExternalGlass }
    .desc = { ent-AirlockExternalGlass.desc }
    .suffix = Внешний, Стеклянный, Легион, Закрыт
ent-AirlockExternalGlassNukeopLocked = { ent-AirlockExternalGlass } (Не использовать)
    .desc = { ent-AirlockExternalGlass.desc }
    .suffix = Внешний, Стеклянный, Легион пепла, Закрыт (Не использовать)
...
ent-AirlockEVAGlassLocked = { ent-AirlockCommandGlassLocked }
    ...
    .suffix = ВКД, Закрыт
ent-AirlockLegionGlassLocked = { ent-AirlockLegionGlass }
    .desc = { ent-AirlockLegionGlass.desc }
    .suffix = Легион, Закрыт
ent-AirlockLegionNukeopGlassLocked = { ent-AirlockLegionGlass } (Не использовать)
    .desc = { ent-AirlockLegionGlass.desc }
    .suffix = Легион пепла, Закрыт (Не использовать)
...
ent-AirlockLegionLocked = { ent-AirlockLegion }
    .desc = { ent-AirlockLegion.desc }
    .suffix = Легион, Закрыт
ent-AirlockLegionNukeopLocked = { ent-AirlockLegion } (Не использовать)
    .desc = { ent-AirlockLegion.desc }
    .suffix = Легион пепла, Закрыт (Не использовать)
...
ent-AirlockExternalShuttleLegionLocked = { ent-AirlockShuttleLegion }
    .desc = { ent-AirlockShuttleLegion.desc }
    .suffix = Внешний, Стыковочный, Легион, Закрыт
ent-AirlockExternalShuttleNukeopLocked = { ent-AirlockShuttleLegion } (Не использовать)
    .desc = { ent-AirlockShuttleLegion.desc }
    .suffix = Внешний, Стыковочный, Легион пепла, Закрыт (Не использовать)
...
ent-AirlockExternalGlassShuttleLegionLocked = { ent-AirlockGlassShuttleLegion }
    .desc = { ent-AirlockGlassShuttleLegion.desc }
    .suffix = Легион, Закрыт, Стеклянный
ent-AirlockExternalGlassShuttleNukeopLocked = { ent-AirlockGlassShuttleLegion } (Не использовать)
    .desc = { ent-AirlockGlassShuttleLegion.desc }
    .suffix = Легион пепла, Закрыт, Стеклянный (Не использовать)
...
ent-HighSecArmoryLocked = { ent-HighSecDoor }
    .desc = { ent-HighSecDoor.desc }
    .suffix = Оружейная, Закрыт
ent-AirlockHatchLegionLocked = { ent-AirlockHatchLegion }
    .desc = { ent-AirlockHatchLegion.desc }
    .suffix = Легион, Закрыт
