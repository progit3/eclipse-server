...
ent-WindoorLegionLocked = { ent-Windoor }
    .desc = { ent-Windoor.desc }
    .suffix = Легион, Закрыт
ent-WindoorSecureLegionLocked = { ent-WindoorSecure }
    .desc = { ent-WindoorSecure.desc }
    .suffix = Легион, Закрыт
ent-PlasmaWindoorLegionLocked = { ent-WindoorPlasma }
    .desc = { ent-WindoorPlasma.desc }
    .suffix = Легион, Закрыт, Плазма
ent-PlasmaWindoorSecureLegionLocked = { ent-WindoorSecurePlasma }
    .desc = { ent-WindoorSecurePlasma.desc }
    .suffix = Легион, Закрыт, Плазма
ent-UraniumWindoorLegionLocked = { ent-WindoorUranium }
    .desc = { ent-WindoorUranium.desc }
    .suffix = Легион, Закрыт, Уран
ent-UraniumWindoorSecureLegionLocked = { ent-WindoorSecureUranium }
    .desc = { ent-WindoorSecureUranium.desc }
    .suffix = Легион, Закрыт, Уран
ent-WindoorNukeopLocked = { ent-Windoor } (Не использовать)
    .desc = { ent-Windoor.desc }
    .suffix = Легион пепла, Закрыт (Не использовать)
ent-WindoorSecureNukeopLocked = { ent-WindoorSecure } (Не использовать)
    .desc = { ent-WindoorSecure.desc }
    .suffix = Легион пепла, Закрыт (Не использовать)
ent-PlasmaWindoorNukeopLocked = { ent-WindoorPlasma } (Не использовать)
    .desc = { ent-WindoorPlasma.desc }
    .suffix = Легион пепла, Закрыт, Плазма (Не использовать)
ent-PlasmaWindoorSecureNukeopLocked = { ent-WindoorSecurePlasma } (Не использовать)
    .desc = { ent-WindoorSecurePlasma.desc }
    .suffix = Легион пепла, Закрыт, Плазма (Не использовать)
ent-UraniumWindoorNukeopLocked = { ent-WindoorUranium } (Не использовать)
    .desc = { ent-WindoorUranium.desc }
    .suffix = Легион пепла, Закрыт, Уран (Не использовать)
ent-UraniumWindoorSecureNukeopLocked = { ent-WindoorSecureUranium } (Не использовать)
    .desc = { ent-WindoorSecureUranium.desc }
    .suffix = Легион пепла, Закрыт, Уран (Не использовать)
