...
ent-LegionBomb = бомба Легиона
    .desc = Бомба для оперативников и агентов Легиона. Настоящее дело, никаких тренировок, приступайте!
ent-LegionBombFake = { ent-LegionBomb }
    .desc = { ent-LegionBomb.desc }
    .suffix = Обманка
