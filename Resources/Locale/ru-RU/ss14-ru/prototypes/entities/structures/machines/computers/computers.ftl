...
ent-ComputerShuttleAshLegion = консоль управления шаттлом Легион пепла
    .desc = Используется для пилотирования корабля Легион пепла.
...
ent-CentcommComputerComms = консоль связи Эйдосской империи
...
ent-ComputerXenoborgsControl = консоль управления ксеноборгов
    .desc = Используется для удалённого управления ксеноборгами
ent-ComputerSurveillanceWirelessXenoborgCameraMonitor = монитор беспроводных камер ксеноборгов
    .desc = Монитор беспроводных камер наблюдения ксеноборгов. Вы наблюдаете за ними. Возможно.
ent-StationAiFixerComputer = Консоль восстановления ИИ
    .desc = используется для ремонта повреждённых исскуственных интелектов
