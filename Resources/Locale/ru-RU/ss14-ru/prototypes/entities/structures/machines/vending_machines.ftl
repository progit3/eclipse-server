...
ent-VendingMachineBoozeLegion = БухлоМат
...
ent-VendingMachineLegionDrobe = ЛегионШкаф
    .desc = Шкаф-машина, закодированная Легионом, содержит элитную экипировку для различных операций.
...
ent-VendingMachineChemicalsLegion = ЛегионСоки
    .desc = Надеюсь, не из свежевыжатых легионовцев?
