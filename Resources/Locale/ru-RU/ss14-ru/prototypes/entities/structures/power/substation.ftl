...
ent-SubstationBasicEmpty = { ent-SubstationBasic }
    ...
    .suffix = Пустой
ent-AutomaticTransferSubstation = автоматическая резервная подстанция
    .desc = Подстанция со встроенным кабельным узлом: слева приоритетный высоковольтный вход, справа резервный вход Протоядра, снизу средневольтный выход. Под ней нельзя размещать трубы или провода; подключайте кабели с разных сторон.
    .suffix = Автоматический резерв, 2,5МДж
