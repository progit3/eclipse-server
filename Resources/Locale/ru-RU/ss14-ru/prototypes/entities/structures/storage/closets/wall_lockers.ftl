...
ent-LockerWallEvacRepair = настенный шкаф эвак-ремонта
    .desc = Аварийный набор для аварийной эвакуации.
...
ent-LockerWallPrisoner8 = { ent-LockerWallBasePrisoner }
    .desc = { ent-LockerWallBasePrisoner.desc }
    .suffix = 8
ent-LockerWallLegion = кроваво-красный настенный шкаф
    .desc = Это настенный шкаф для хранения вещей кроваво-красного цвета.
    .suffix = Закрыт
