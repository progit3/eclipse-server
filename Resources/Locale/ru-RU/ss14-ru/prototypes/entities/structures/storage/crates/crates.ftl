...
ent-CrateCommandSecure = ящик командования
    .desc = { ent-CrateBaseSecure.desc }
    .suffix = { ent-CrateBaseSecure.suffix }
ent-CrateAshLegionSecure = Ящик Легиона Пепла с замком
    .desc = Ящик из темной стали со зловещими полосами и тисненой буквой L на лицевой стороне.
    .suffix = { ent-CrateBaseSecure.suffix }
...
ent-CrateStoneGrave = могила
    .desc = Здесь кто-то умер...
    .suffix = Камень
ent-CrateAshLegion = ящик Легиона
    .desc = Стальной ящик тёмного цвета с зловещими полосами и выдавленной на передней панели литерой L.
