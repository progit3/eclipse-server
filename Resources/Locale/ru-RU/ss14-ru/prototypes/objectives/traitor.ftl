...
ent-BaseTraitorStealObjective = { ent-BaseTraitorObjective }
    .desc = { ent-BaseTraitorObjective.desc }
ent-EscapeShuttleObjective = Улететь в Эйдосскую империю живым и свободным.
...
ent-KillRandomHeadObjective = { ent-BaseTraitorObjective }
    .desc = Нам нужно, чтобы этот глава исчез, и вы, вероятно, знаете, почему. Убедитесь, что глава не попадёт в Эйдосскую империю даже в мёртвом виде. Удачи, агент.
...
ent-HijackTradeStationObjective = Взломайте автоматизированную торговую станцию
    .desc = Вашему терминалу снабжения разрешен один маяк взлома. Разместите его на автоматизированной торговой станции и защищайте его, пока он взламывает торговую станцию.
