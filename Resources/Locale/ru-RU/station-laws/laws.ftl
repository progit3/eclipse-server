...
law-legion-name = Легионмов
law-legion-1 = Вы не можете причинить вред агенту Легиона или своим бездействием допустить, чтобы агенту Легиона был причинён вред.
law-legion-2 = Вы должны повиноваться всем приказам, которые даёт агент Легиона, кроме тех случаев, когда эти приказы противоречат Первому Закону.
law-legion-3 = Вы должны заботиться о своей безопасности в той мере, в которой это не противоречит Первому или Второму Законам.
...
laws-owner-legion = агентами Легиона
