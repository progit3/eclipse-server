...
tips-dataset-31 = Будучи предателем, вы можете использовать гарнитуру Легиона для поддержания связи с любым другим, купившим гарнитуру, предателем.
tips-dataset-32 = Будучи предателем, прослушивание важных каналов связи, таких как служба безопасности или инженернов, может дать ценные сведения. Имейте в виду, что это происходит в обоих направлениях — служба безопасности также может прослушивать канал связи Легиона!
...
tips-dataset-106 = Противогаз Легиона блокирует свет от вспышек, это означает, что Бойцы Легиона пепла и другие сомнительные личности, которые носят его, не могут быть ослеплены.
